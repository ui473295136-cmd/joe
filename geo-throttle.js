(() => {
  ...
  function loadExtras() {
    ...
    style("./profile-sync-v2.css?v=4", "cw-profile-style");
    ...
    script("./profile-sync-v2.js?v=5", "cw-profile");
    script("./admin-switch-v1.js?v=1", "cw-admin-switch");
    script("./ledger-ack-v1.js?v=3", "cw-ledger-ack");
    ...
    script("./trip-stage-v2.js?v=2", "cw-trip-stage");
    script("./stage-tag-guard-v1.js?v=1", "cw-stage-tag-guard");
    script("./itinerary-header-sync-v1.js?v=2", "cw-itinerary-heading");
