const CACHE='chuanxi-2026-v11';
const CORE=['./','./index.html','./dashboard.html','./avatars.js','./roadtrip-pro.js','./mobile-fix.js','./puzi-avatar.js','./map-app.js','./personal-app.js','./pro/p1.txt','./pro/p2.txt','./pro/p3.txt','./pro/p4.txt','./pro/p5.txt','./pro/p6.txt','./ios-widget.js','./manifest.webmanifest','./icon.svg','./road-routes.json'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.origin===location.origin){
    const networkFirst=['/joe/','/joe/index.html','/joe/dashboard.html','/joe/avatars.js','/joe/roadtrip-pro.js','/joe/mobile-fix.js','/joe/puzi-avatar.js','/joe/map-app.js','/joe/personal-app.js','/joe/ios-widget.js'].some(x=>u.pathname===x);
