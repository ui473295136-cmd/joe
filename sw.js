const CACHE='chuanxi-2026-v5';
const CORE=['./','./index.html','./dashboard.html','./cloud-sync.js','./ios-widget.js','./manifest.webmanifest','./icon.svg','./road-routes.json'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.origin===location.origin){
    const networkFirst=['/joe/','/joe/index.html','/joe/dashboard.html','/joe/cloud-sync.js','/joe/ios-widget.js'].some(x=>u.pathname===x);
