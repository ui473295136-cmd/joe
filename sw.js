const CACHE='chuanxi-2026-v6';
const CORE=['./','./index.html','./dashboard.html','./avatars.js','./cloud-sync.js','./ios-widget.js','./manifest.webmanifest','./icon.svg','./road-routes.json'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.origin===location.origin){
    const networkFirst=['/joe/','/joe/index.html','/joe/dashboard.html','/joe/avatars.js','/joe/cloud-sync.js','/joe/ios-widget.js'].some(x=>u.pathname===x);
